...
import 'package:boucherie_conakry/ui/views/butchers/entry/entry.dart';
import 'package:boucherie_conakry/ui/views/butchers/filter_dialog/filter_dialog.dart';
          ...
          builder: (BuildContext context,
              ...
              products.hasData && products.data.isNotEmpty
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, i) => ButchersEntry(
                        UniqueKey(),
